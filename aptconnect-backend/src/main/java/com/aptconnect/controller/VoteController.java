...
import com.aptconnect.entity.vote.VotePollRequestDTO;
import com.aptconnect.entity.vote.VoteStatus;
import org.springframework.stereotype.Controller;
import org.springframework.ui.Model;
import com.aptconnect.entity.User;
import com.aptconnect.service.VoteService;
...
public class VoteController {
    ...
    public String updateVote(@PathVariable("pollId") Long pollId, @ModelAttribute VotePoll updatedVote,
                             @RequestParam List<String> options, @ModelAttribute("currentUser") User currentUser) {
        voteService.updateVote(pollId, updatedVote, options, currentUser);
        return "redirect:/votes/" + pollId;
    }
