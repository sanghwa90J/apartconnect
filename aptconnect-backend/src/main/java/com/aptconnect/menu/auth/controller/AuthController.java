package com.aptconnect.menu.auth.controller;

import com.aptconnect.menu.apartment.entity.Apartment;
import com.aptconnect.menu.apartment.service.ApartmentService;
...
public class AuthController {
    ...
    public String register(@RequestParam String email,
        ...
        // ✅ 회원가입 처리
        userService.registerUser(email, password, name, apartment.getName(), buildingNumber, unitNumber, inviteCode);
